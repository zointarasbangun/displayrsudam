...
@section('penghargaan')
    ...
    <section id="penghargaan" class="bg-blue-50 py-16 px-6 md:px-20">
        ...
        <div class="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
            ...
            <p class="text-lg text-gray-600 mb-4 text-justify">This medical and health care facility distinguishes itself from the competition by providing
...
@section('virtual')
    ...
    <section id="virtual-tour" class="py-16 px-6 md:px-20">
        <div class="container mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mb-4 text-justify">Jelajahi rumah sakit kami secara virtual melalui tur 3D yang interaktif.</p>
